...
#define ProfileBeginTask( name ) TAL_BeginNamedTask( TAL_GetThreadTrace(), (char*)(name) );
#define ProfileEndTask() TAL_EndTask();
#define ProfileBeginFrame( name ) TAL_BeginNamedTask( TAL_GetThreadTrace(), (char*)(name) );
#define ProfileEndFrame() TAL_EndTask();
